...
class Ito_diffusion_sheaf(Ito_diffusion):
    ...
    def __init__(self, x0=0, T=1, scheme_steps=100, n_paths=10, path_mixing=0.99,                 barrier=None, barrier_condition=None):
        Ito_diffusion.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                         barrier=barrier, barrier_condition=barrier_condition)
...
class BM_sheaf(Ito_diffusion_sheaf, BM):
    ...
    def __init__(self, x0=0, T=1, scheme_steps=100, n_paths=10, path_mixing=0.99,                 drift=0, vol=1, barrier=None, barrier_condition=None):
        Ito_diffusion_sheaf.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                                     n_paths=n_paths, path_mixing=path_mixing,                                     barrier=barrier, barrier_condition=barrier_condition)
        BM.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps, drift=drift, vol=vol,                    barrier=barrier, barrier_condition=barrier_condition)
...
class GBM_sheaf(Ito_diffusion_sheaf, GBM):
    ...
    def __init__(self, x0=0, T=1, scheme_steps=100, n_paths=10, path_mixing=0.99,                 drift=0, vol=1, barrier=None, barrier_condition=None):
        Ito_diffusion_sheaf.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                                     n_paths=n_paths, path_mixing=path_mixing,                                     barrier=barrier, barrier_condition=barrier_condition)
        GBM.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps, drift=drift, vol=vol,                     barrier=barrier, barrier_condition=barrier_condition)
...
class Vasicek_sheaf(Ito_diffusion_sheaf, Vasicek):
    ...
    def __init__(self, x0=1, T=1, scheme_steps=100, n_paths=10, path_mixing=0.99,                 mean_reversion=1, long_term=0, vol=1,                 barrier=None, barrier_condition=None):
        Ito_diffusion_sheaf.__init__(self, x0, T, scheme_steps,                                     n_paths=n_paths, path_mixing=path_mixing,                                     barrier=barrier, barrier_condition=barrier_condition)
        Vasicek.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                         mean_reversion=mean_reversion, long_term=long_term, vol=vol,                         barrier=barrier, barrier_condition=barrier_condition)
...
class CIR_sheaf(Ito_diffusion_sheaf, CIR):
    ...
    def __init__(self, x0=1, T=1, scheme_steps=100, n_paths=10, path_mixing=0.99,                 mean_reversion=1, long_term=0, vol=1,                 barrier=None, barrier_condition=None):
        Ito_diffusion_sheaf.__init__(self, x0, T, scheme_steps,                                     n_paths=n_paths, path_mixing=path_mixing,                                     barrier=barrier, barrier_condition=barrier_condition)
        CIR.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                     mean_reversion=mean_reversion, long_term=long_term, vol=vol,                     barrier=barrier, barrier_condition=barrier_condition)
...
class pseudo_GBM_sheaf(Ito_diffusion_sheaf, pseudo_GBM):
    ...
    def __init__(self, x0=1, T=1, scheme_steps=100, drift=0, vol=1,                 n_paths=10, path_mixing=0.99,                 barrier=None, barrier_condition=None):
        Ito_diffusion_sheaf.__init__(self, x0, T, scheme_steps,                                     n_paths=n_paths, path_mixing=path_mixing,                                     barrier=barrier, barrier_condition=barrier_condition)
        pseudo_GBM.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                            drift=drift, vol=vol,                            barrier=barrier, barrier_condition=barrier_condition)
...
class Pinned_diffusion_sheaf(Ito_diffusion_sheaf, Pinned_diffusion):
    ...
    def __init__(self, x0=0, T=1, scheme_steps=100, alpha=1, vol=1, pin=0,                n_paths=10, path_mixing=0.99):
        Ito_diffusion_sheaf.__init__(self, x0, T, scheme_steps,                                     n_paths=n_paths, path_mixing=path_mixing)
        Pinned_diffusion.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                                  alpha=alpha, vol=vol, pin=pin)
...
class Alpha_pinned_BM_sheaf(Pinned_diffusion_sheaf, Alpha_pinned_BM):
    ...
    """
    def __init__(self, x0=0, T=1, scheme_steps=100, alpha=1, vol=1, pin=0,                n_paths=10, path_mixing=0.99):
        Pinned_diffusion_sheaf.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps, pin=pin,                                        n_paths=n_paths, path_mixing=path_mixing)
        Alpha_pinned_BM.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps,                                 alpha=alpha, vol=vol, pin=pin)
...
class F_pinned_BM_sheaf(Pinned_diffusion_sheaf, F_pinned_BM):
    ...
    def __init__(self, x0=0, T=1, scheme_steps=100, distr=None, pin=0,                n_paths=10, path_mixing=0.99):
        Pinned_diffusion_sheaf.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps, pin=pin,                                        n_paths=n_paths, path_mixing=path_mixing)
        F_pinned_BM.__init__(self, x0=x0, T=T, scheme_steps=scheme_steps, distr=distr, pin=pin)
